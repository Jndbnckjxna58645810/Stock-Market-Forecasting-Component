...
with col1:
    ...
    with btn_col2:
        if st.button("🗑️ Delete", key=f"del_{selected_processed}", use_container_width=True):
...
with col2:
    ...
    with btn_col2:
        if st.button("🗑️ Delete", key=f"del_{selected_raw}", use_container_width=True):
...
with col3:
    ...
    with btn_col2:
        if st.button("🗑️ Delete", key=f"del_{selected_macro}", use_container_width=True):
